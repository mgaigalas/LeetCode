...
Given a string <code>s</code>, return the <strong>maximum</strong> length of a substring such that it contains <em>at most two occurrences</em> of each character.
<p>&nbsp;</p>
