...
<img alt="" src="ex1.jpg" style="width: 523px; height: 342px;">
...
Solution used in this problem uses stacks to read backwards while constructing linked list backwards (n->head), 
however, other way to solve it would be reversing both lists and building new linked list backwards